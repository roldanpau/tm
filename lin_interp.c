/** \file lin_interp.c
  * \brief Interpolate curve linearly on an equispaced set of nodes.
  *
  * Read a curve from file, interpolate it linearly on an equispaced set of
  * nodes, and print interpolated curve to stdout.
  *
  * NOTES: 
...
main (int argc, char *argv[])
{
	...
	/* Interpolate curve linearly on an equispaced set of nodes */
  {
