/** \file FT.c
  * \brief Compute Fourier-Taylor series and write it to file (for SM1 and SM2) \f$.
  *
  * First and foremost, compute ALL the coefficients of the Fourier-Taylor
  * series, in the form of divided differences ddA and ddB. Write them to file
  * ddA.res and ddB.res. 
  *
  * Then, given \f$ (I,\phi') \f$, find the value of the (N,M)-truncated
  * Fourier-Taylor series at that point: 
  * \f\[ pd{L^*}{\phi'} = \sum_{n=1}^{N} (B_n(I) \sin{n\phi'} + A_n(I)
  * \cos{n\phi'}). \f\]
  *
  *	The degree (N,M) of the Fourier-Taylor series is specified in the code.
  *
